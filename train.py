...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str,
        default='/Users/kbh0608/Desktop/python/fashion/task1/github/Train',
        help='fahsion image directory'
    )
    parser.add_argument('--info_path', type=str,
        default='/Users/kbh0608/Desktop/python/fashion/task1/github/info_etri20_emotion_train.csv',
